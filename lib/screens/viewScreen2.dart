...
class ViewPatientScreen2 extends StatelessWidget {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetail('Location', patient['location']),
                    ],
                  ),
                ),
          ...
          return pw.Column(
            ...
            children: [
                  ...
                  pw.Expanded(
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        _buildPDFDetail('Phone',
                            '${patient['countryCode']} ${patient['phoneNumber']}'),
                        _buildPDFDetail('Referred By', patient['referredBy']),
                        _buildPDFDetail('Location', patient['location']),
                      ],
                    ),
                  ),
                ],
              ...
              pw.Align(
                ...
                child: pw.Image(signatureImage, width: 150, height: 90),
              ),
            ],
          );
        },
